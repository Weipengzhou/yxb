...
var TableColNum = 7;
    ...
    var SelectServer = new Class({
        ...
        init_default_select: function () {
            ...
            if (!this.default_areaid || !server_data[this.default_areaid]) {
        ...
        show_area_list: function () {
            ...
            for (area_id in server_data) {
                ...
                var el_id = parseInt((position[1] - 1) * TableColNum) + parseInt(position[0]);
        ...
        show_server_list: function (area_id) {
            ...
            var select_server = function () {
                ...
                if (that.select_server_func) {
                    ...
                    var return_key = 'login_return_url';
                    var return_url = Cookie.read(return_key);
                    Cookie.dispose(return_key);
                    if (return_url) {
                    ...
                    var url = HttpsCgiRootUrl + "/show_login.py?" + Object.toQueryString(arg);
